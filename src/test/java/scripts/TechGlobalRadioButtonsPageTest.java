...
public class TechGlobalRadioButtonsPageTest extends TechGlobalBase {
    /*
...
Select "JavaScript" validate it is
     */
    @BeforeMethod
    public void setPage() {
...
Select "Playwright" validate it is selected but the other 2 are deselected
    ...
    @Test(priority = 2, description = "Validating TechGlobal Language Radio Buttons2")
